...
val lastshowUsageDialogTimeStamp = KLongKey(KEY_LAST_USAGE_DIALOG_STAMP, 0)
val lastshowESMDialogTimeStamp = KLongKey(KEY_LAST_ESM_DIALOG_STAMP, 0)
val openTimesKey = KIntKey(KEY_OPEN_TIMES, 0)
val weekUsage = KStringKey(KEY_WEEK_USAGE, "0,0,0,0,0,0,0")
val trackUserID = KStringKey(KEY_USER_TRACK_ID, "")
...
val timestatusPageVisitStats = KIntKey(KEY_STATUSPAGE_VISIT_CNT, 0)
val timelistPageVisitStats = KIntKey(KEY_LIST_VISIT_CNT, 0)
val shutDownDialogueStats = KIntKey(KEY_SHUTDOWN_DIALOGUE, 0)
val ignoreDialogueStats = KIntKey(KEY_IGNORE_DIALOGUE, 0)
val lastReadTweetTimestampKey = KLongKey(KEY_LASTREAD_TSTAMP, 0)
val newestTweetTimestampKey = KLongKey(KEY_NEWEST_TSTAMP, 0)
val newestTweetStampKeyForList = KStringKey(KEY_NEWEST_STAMP_LIST, "")
val lastReadTweetStampKeyForList = KStringKey(KEY_LASTREAD_STAMP_LIST, "")
val popularTweetsCache = KStringKey(KEY_POPULAR_TWEETS_CACHE, "")
val popularTweetsTimeStemp = KLongKey(KEY_POPULAR_TWEETS_TIMESTAMP,  0)
...
val defaultAutoRefreshKey = KBooleanKey(KEY_DEFAULT_AUTO_REFRESH, true)
...
//drustz: change all auto_refresh related to true
